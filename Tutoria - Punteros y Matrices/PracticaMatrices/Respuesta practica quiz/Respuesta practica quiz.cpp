...
int main() {
    ...
    cout<< endl<<"#########################################"<<endl << endl;
        ...
        // Pedir al usuario que introduzca un n�mero a buscar
        cout << "Introduce el numero a buscar: ";
        cin >> numero;

        // Buscar el n�mero en la matriz y guardar las posiciones
        for (int i = 0; i < tamano; i++) {
            for (int j = 0; j < tamano; j++) {
        ...
        // Imprimir las posiciones del n�mero encontrado
        if (contador > 0) {
            ...
            cout << "El n�mero " << numero << " no se encuentra en la matriz." << endl;
        }
